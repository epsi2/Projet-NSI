...
def jeumulti(evt):
    ...
    elif tour%2 == 0 and tourmulti%2 == 1 or tour%2 == 1 and mode==0 :
...
def multi(princ, case):
    print("\n***********************************\n")
    typej = int(input("Tapez 0 pour être le joueur O et 1 pour être le joueur X : "))
...
print("\n***********************************\n")
mode = int(input("Tapez 0 pour jouer sur le même appareil, tapez 1 pour jouer en local : "))
if mode == 1:
