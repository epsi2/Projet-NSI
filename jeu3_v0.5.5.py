...
class Pong():
    ...
    def __init__(self):
        ...
        self.bouton_meme_ordinateur = Button(self.fenetre_pong,width=50, height= 50, command = lambda:[self.destruction(),self.meme_ordinateur(),self.commencement_jeu(),self.apparition_barre(),], bg='blue',text= 'même ordinateur')
    ...
    def mouvement_joueurs_et_barres(self):
            ...
            if len(self.liste_barres) != 0:
                for self.barre in self.liste_barres :
                    ...
                    self.r = f"{self.coul_act[0]+self.coul_act[1]}"
                    self.v = f"{self.coul_act[2]+self.coul_act[3]}"
