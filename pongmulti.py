...
def multi():
    ...
    print("\n***********************************\n") 
    typej = int(input("Tapez 0 pour être le joueur 1 et 2 pour être le joueur 2 : ")) 
    fin=True
...
mode = int(input("Tapez 0 pour jouer sur le même appareil, tapez 1 pour jouer en local : "))     #choix du mode de jeu
